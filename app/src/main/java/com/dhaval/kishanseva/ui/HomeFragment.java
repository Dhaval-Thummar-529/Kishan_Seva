...
import com.dhaval.kishanseva.login.LoginActivity;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mName = view.findViewById(R.id.tvNameHome);
        mNumber = view.findViewById(R.id.tvPhoneHome);
        logout = view.findViewById(R.id.btnLogout);
        weather = view.findViewById(R.id.btnWeatherHome);
